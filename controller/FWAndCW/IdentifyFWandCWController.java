...
public class IdentifyFWandCWController extends Controller implements
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals("FW")) {
			...
			if (listElement != null) {
				...
				// fertig mit der Arbeit, forAllPressed zur�cksetzten
				model.getIdentifyFWandCWPanel().setWord(selectedWord);
				if (allCharactersSet() && !allWordsSet()) {
					model.showMenu("fwAndCW");
	...
	/**
	 * So k�nnte es im Gro�en und Ganezn gel�st werden. Selbiges muss auch f�r Fw's gemacht werden.
	 * 
	...
	public void caretUpdate(CaretEvent e) {
		if (e.getSource() instanceof JTextPane
			...
			if (token instanceof Word
				...
				// L�nge gr��er 1 (sonst Probleme: wenn ein Satzzeichen nach einem Wort kommt
				// wird dies auch als Token verwendet)
				// Wenn W�rter auch Gr��e 1 haben k�nnen: alle Satzzeichen mit token.getContent() != ".")
				 // etc. ausschlie�en
